/*
    ...
    Author				:	Neil Johnson
    Date				:	2020-04-20
    Script name 		:	H5MWS060B_PrintLbl
    Script arguments	:
    Prerequisites		:
            
    User highlight balance id in MWS060 and then clicks script button. Execute MMS060MI.PrtPutAwayLbl API with warehouse, item number, location, lot number, and container number assigned to the API fields.
   
    *Nbr   Date   User id     Description
    *NJ01 200417  NJOHNSON    Re-written during uplift

*/
var H5MWS060B_PrintLbl = /** @class */ (function () {
    function H5MWS060B_PrintLbl(scriptArgs) {
     ...
     */
    H5MWS060B_PrintLbl.Init = function (args) {
        new H5MWS060B_PrintLbl(args).run();
    };
    H5MWS060B_PrintLbl.prototype.run = function () {
        var _this = this;
    ...
    H5MWS060B_PrintLbl.prototype.OnClickButton = function () {
    ...
    H5MWS060B_PrintLbl.prototype.createAPIRequestUrl = function (program, transaction, input) {
    ...
    H5MWS060B_PrintLbl.prototype.OnFail = function (e, msg) {
    ...
    H5MWS060B_PrintLbl.prototype.OnSuccess = function (response) {
    ...
    H5MWS060B_PrintLbl.prototype.parseArgs = function (args) {
        try {
            //  Split arguments
    ...
    H5MWS060B_PrintLbl.prototype.getScreenFieldValue = function (fieldName) {
        var fieldValue = null;
        try {
    ...
    H5MWS060B_PrintLbl.prototype.debug = function (type, message) {
        if (this.debugOn) {
            if (type == "I")
    ...
    return H5MWS060B_PrintLbl;
}());
//# sourceMappingURL=H5MWS060B_PrintLbl.js.map