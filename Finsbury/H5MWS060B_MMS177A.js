...
*/
var H5MWS060B_MMS177A = /** @class */ (function () {
    function H5MWS060B_MMS177A(scriptArgs) {
     ...
     */
    H5MWS060B_MMS177A.Init = function (args) {
        new H5MWS060B_MMS177A(args).run();
    };
    H5MWS060B_MMS177A.prototype.run = function () {
        var _this = this;
    ...
    H5MWS060B_MMS177A.prototype.OnClickButton = function () {
    ...
    H5MWS060B_MMS177A.prototype.parseArgs = function (args) {
        try {
            //  Split arguments
    ...
    H5MWS060B_MMS177A.prototype.getScreenFieldValue = function (fieldName) {
        var fieldValue = null;
        try {
    ...
    H5MWS060B_MMS177A.prototype.debug = function (type, message) {
        if (this.debugOn) {
            if (type == "I")
    ...
    return H5MWS060B_MMS177A;
}());
//# sourceMappingURL=H5MWS060B_MMS177A.js.map